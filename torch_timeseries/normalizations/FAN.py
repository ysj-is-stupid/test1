...
from .FAN_for_fourier import FAN2_DualStream
from .FAN_for_fourier import FAN2
from .FAN_for_fourier import FAN3_MLP_DualStream
...
class FAN(nn.Module):
    ...
    def _build_model(self):
        ...
        self.model_freq = FAN3_MLP_DualStream(self.seq_len, self.pred_len)
